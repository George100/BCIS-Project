////////////EVENT LISTENER CODE\\\\\\\\\\\\\\\
// Shouldnt need to play with anything in here, just code that will come in handy,
// especially when we implement support for touch screens.
...
Events.prototype.closeRegion = function() {
    ...
    if (pos !== null && this.context.isPointInPath(pos.x, pos.y)) {
        ...
        // handle onmouseover
        else if (!this.mouseOver && this.regionIndex != this.mouseOverRegionIndex && this.currentRegion.onmouseover !==
            undefined) {
